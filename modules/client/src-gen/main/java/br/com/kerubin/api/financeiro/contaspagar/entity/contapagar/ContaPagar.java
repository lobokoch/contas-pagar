...
public class ContaPagar {
	...
	@ApiModelProperty(notes = "Plano de contas", required = true, position = 2)
	private PlanoContaLookupResult planoContas;
	
	@NotNull(message="\"Data de vencimento\" é obrigatório.")
	@ApiModelProperty(notes = "Data de vencimento", required = true, position = 3)
	private java.time.LocalDate dataVencimento;
	
	@NotNull(message="\"Valor total\" é obrigatório.")
	@ApiModelProperty(notes = "Valor total", required = true, position = 4)
	...
	@ApiModelProperty(notes = "Conta bancária", position = 6)
	private ContaBancariaLookupResult contaBancaria;
	
	@ApiModelProperty(notes = "Cartão de crédito", position = 7)
	...
	@ApiModelProperty(notes = "Fornecedor", position = 9)
	private FornecedorLookupResult fornecedor;
	
	@NotNull(message="\"Conta paga\" é obrigatório.")
	@ApiModelProperty(notes = "Conta paga", required = true, position = 10)
	private Boolean contaPaga = false;
	
	@ApiModelProperty(notes = "Data do pagamento", position = 11)
	private java.time.LocalDate dataPagamento;
	
	@ApiModelProperty(notes = "Descontos", position = 12)
	private java.math.BigDecimal valorDesconto;
	
	@ApiModelProperty(notes = "Multas", position = 13)
	private java.math.BigDecimal valorMulta;
	
	@ApiModelProperty(notes = "Juros mora", position = 14)
	private java.math.BigDecimal valorJuros;
	
	@ApiModelProperty(notes = "Acréscimos", position = 15)
	private java.math.BigDecimal valorAcrescimos;
	
	@ApiModelProperty(notes = "Valor total pago", position = 16)
	private java.math.BigDecimal valorPago;
	
	@ApiModelProperty(notes = "Mostrar mais opções", position = 17)
	private Boolean maisOpcoes = false;
	
	@Size(max = 255, message = "\"Id da conciliação bancária\" pode ter no máximo 255 caracteres.")
	@ApiModelProperty(notes = "Id da conciliação bancária", position = 18)
